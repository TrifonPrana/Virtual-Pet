...
class Clothes_Menu:
    def __init__(self,game,data):
        ...
        self.menu_page = load_image("images/menu/menu_page.png",SCREEN_WIDTH,SCREEN_HIGHT)
        ...
        #Создаем кнопки
        self.next_button = Button("Вперед",SCREEN_WIDTH - BUTTON_WIDTH - GRID*8,SCREEN_HIGHT - GRID*14
        ,width=BUTTON_WIDTH//1.2,height=BUTTON_HEIGHT//1.2,func=self.to_next)

        self.back_button = Button("Назад",GRID*12,SCREEN_HIGHT - GRID*14
        ,width=BUTTON_WIDTH//1.2,height=BUTTON_HEIGHT//1.2,func=self.to_previous)

        

        self.buy_button = Button("Купить",SCREEN_WIDTH//2 - BUTTON_WIDTH//1.5 // 2,SCREEN_HIGHT//2 + GRID*10
        ,width=BUTTON_WIDTH//1.5,height=BUTTON_HEIGHT//1.5,func=self.buy)

        
        self.bottom_width = SCREEN_WIDTH+10
        self.bottom_label_off = load_image("images/menu/bottom_label_off.png",SCREEN_WIDTH,SCREEN_HIGHT)
        self.bottom_label_on = load_image("images/menu/bottom_label_on.png",SCREEN_WIDTH,SCREEN_HIGHT)
        self.top_label_off = load_image("images/menu/top_label_off.png",SCREEN_WIDTH,SCREEN_HIGHT)
        self.top_label_on = load_image("images/menu/top_label_on.png",SCREEN_WIDTH,SCREEN_HIGHT)
    ...
    def render_item(self):
        ...
        self.item_rect.center = (SCREEN_WIDTH // 2,SCREEN_HIGHT // 2)
    ...
    def prepare_button(self):
        ...
        self.use_button = Button(self.use_button_text,GRID*12,SCREEN_HIGHT//2 + GRID*8
...
class Food_Menu:
    def __init__(self,game):
        ...
        self.buy_eat_button = Button("Купить",SCREEN_WIDTH//2 - BUTTON_WIDTH//1.5 // 2,SCREEN_HIGHT//2 + GRID*10
...
class Game_Menu:
    def __init__(self,game):
        self.game = game
        self.game_bg = load_image("images/game_background.png",SCREEN_WIDTH,SCREEN_HIGHT) 
    ...
    def draw(self,screen):
        ...
        if self.points >= self.points_record:
            self.points_record=self.points+1
...
class Dog(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.rect.centery = SCREEN_HIGHT - GRID*14
    def update(self):
...
class Game:
    def __init__(self):
        ...
        self.background = load_image("images/background.png",SCREEN_WIDTH,SCREEN_HIGHT)
        ...
        self.eat_button = Button("Еда",button_x,GRID*9,func=self.eat_menu_on)
        self.clothes_button = Button("Одежда",button_x,GRID*10+BUTTON_HEIGHT,func=self.clothes_menu_on)
        self.play_button = Button("Игры",button_x,GRID*11+BUTTON_HEIGHT * 2,func=self.play_menu_on)

        #Создаем объект для меню одежды
